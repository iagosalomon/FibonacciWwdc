...
class ButtonViewController : UINavigationController {
    ...
    override func loadView() {
        ...
        imagemFundoView.heightAnchor.constraint(equalToConstant: height - 14).isActive = true
        ...
        //        button0.frame = CGRect(x: 0, y: height + height/3, width:button_size, height: height/3)
...
/*:
 The Fibonacci sequence is a beautifull mathematics sequence that apears everywhere in nature, from sunflowers to our galaxy, and even in our DNA.
 
 
 The sequence is 1,1,2,3,5,8,13... and so on.
 
 
 
 It`s made from adding the two past numbers so 1+1=2, 1+2=3, 3+2=4.
 
 
 To show the beauty of these sequence I have built a keyboard, insert the numbers on the sequence, the ones that apear on the right side of the equal sing, and see how diferent musics apears depending on your timing and feeling, wich are essencial in music.
 
 Don`t worry if you get a number wrong,just go to the next one and continue playing and descovering the music hiden in nature.
 */
